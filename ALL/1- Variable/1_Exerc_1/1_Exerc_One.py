...
print('Name: Guilherme Fontes')

#Step 2 -> Show your e-mail
print('E-mail: guilhermehenriquefontes@alunos.utfpr.edu.br\n')
...
print('Name: Bruno Uhlmann Marcato')

#Step 5 -> show your colleague's email
print('E-mail: marcato.2001@alunos.utfpr.edu.br\n')
